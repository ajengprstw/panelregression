...
Why should we use panel data? [^2]
...
Panel regression is a method can build model both the common and individual behaviors of groups. The advantage of a panel data set over a cross-section is that it will allow the researcher great flexibility in modeling of differences in behavior across individual. The challenge from implementation panel regression is the assumption of no unobserved heterogeneity.
...
[^6]: Hsiao, Cheng. Panel Data Analysis.
